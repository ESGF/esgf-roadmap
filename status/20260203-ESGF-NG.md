...
1. Globus Search Team has established a new ElasticSearch cluster in the new environment and have migrated the existing ESGF-1.5 search index to it, and created new ESGF-NG search indices for the production and staging environments.
...
4. Globus Professional Services Team set up staging/integration instances of the discovery, transaction, and consumer APIs using IaC in compliance with Globus Operations Team.
...
In February, the ESGF Publisher team published a CORDEX-CMIP6 example in ESGF-NG. See the CORDEX CMIP6 section below for more detail.
...
This work will continue in March. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/103).
...
This work will continue in March. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/106).
