# 2026-01-06 ESGF-NG Status

ESGF-NG status as of January, 2026.
...
* ESGF2-US is now working on production deployment of the ESGF Event Stream and ESGF-West STAC catalog, currently working on establishing our production hosting environment. We hope both CEDA and ESGF2-US will be ready for onboarding publishers by late January or February. (Data producers who have data ready for publishing before then may contact us to discuss options.)
* In December, the ESGF2-US team conducted another publication run (just like a data challenge) using a different subset of CMIP6 datasets, producing a STAC catalog that was used for demonstrations and training at the AGU25 annual meeting. This catalog is now available for client testing.
* We’re now working on adding ESGF-NG features to the ESG Publisher application to support: (1) authentication (Globus and EGI Check-In), and (2) STAC catalog updates.
...
[No significant changes since last month. This is what we're working on this month!]

The CEDA team is looking into moving its STAC API to a production URL.

The ESGF2-US team is working with Oak Ridge National Laboratory's AWS operations team to establish a production AWS hosting environment managed by ORNL, and with the Globus Operations team to deploy the ESGF-West core architecture in this environment. The deployment includes:
1. Replicating the existing Confluent Kafka cluster (for the event stream) in the new environment or else establishing a new instance and configuring it.
2. Establishing a new ElasticSearch cluster in the new environment and moving the existing ESGF-1.5 search index to it.
3. Deploying production instances of the ESGF STAC catalog components to the new environment.
...
This work will continue in January. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/95).
...
This work will continue in January. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/121).
...
This work will continue in January. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/103).
...
This work will continue in January. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/106).
...
This work will continue in January. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/97).
